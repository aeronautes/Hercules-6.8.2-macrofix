...
---[[ This block added for scratchpad extension aeronautes-pit
devaction = {}
local devlist = {JOYSTICK, DEBUG, Position_Control, ICS_PANEL, General_Packet_Send, ELECTRICAL_PANEL, ENGINE_START_PANEL, PROPELLER_CONTROL_PANEL, THROTTLE_QUADRANT_ASSEMBLY, APU_PANEL, FIRE_HANDLES, BLEED_AIR_PANEL, LANDING_GEAR_LIGHTS_PANEL, FLAPS, HYDRAULIC_CONTROL_PANEL, HUD_PANELS, DISPLAY_BRIGHTNESS_CONTROL, REFERENCE_SET_MODE_SELECT_PANELS, Automatic_Flight_Control_System_Panel, HDG_CRS_Selector_Control_Panel, PILOT_LIGHTING_CONTROLS, COPILOT_LIGHTING_CONTROLS, AUGMENTED_CREW_LIGHTING_CONTROLS, FWD_CARGO_LIGHTING_CONTROL_PANEL, AFT_CARGO_LIGHTING_CONTROL_PANEL, AMU, CNI_MU, CURSOR, FUEL_MANAGEMENT_PANEL, AERIAL_DELIVERY_PANEL, RAMP_CONTROL_PANEL, LOADMASTER_STATION, RAMP_EMERGENCY_CONTROL_PANEL, MISCELLANEOUS, MPCD_INTERFACE, BATTLE_STATION_COMMANDS, FLIGHT_CONTROL, TRIM, THROTTLES, RWR}
for i,j in pairs(devlist) do
